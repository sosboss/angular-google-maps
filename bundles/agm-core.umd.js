(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    MapsAPILoader.ɵprov = i0.ɵɵdefineInjectable({ token: MapsAPILoader, factory: MapsAPILoader.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(MapsAPILoader, [{
                type: i0.Injectable
            }], null, null);
    })();
    ...
    var GoogleMapsAPIWrapper = /** @class */ (function () {
        ...
        GoogleMapsAPIWrapper.prototype.subscribeToMapEvent = function (eventName) {
            ...
            return new rxjs.Observable(function (observer) {
                _this._map.then(function (m) { return m.addListener(eventName, function () {
                    var evArgs = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        evArgs[_i] = arguments[_i];
                    }
                    return _this._zone.run(function () { return observer.next(evArgs); });
                }); });
            });
        };
    ...
    GoogleMapsAPIWrapper.ɵfac = function GoogleMapsAPIWrapper_Factory(t) { return new (t || GoogleMapsAPIWrapper)(i0.ɵɵinject(MapsAPILoader), i0.ɵɵinject(i0.NgZone)); };
    GoogleMapsAPIWrapper.ɵprov = i0.ɵɵdefineInjectable({ token: GoogleMapsAPIWrapper, factory: GoogleMapsAPIWrapper.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(GoogleMapsAPIWrapper, [{
                type: i0.Injectable
            }], function () { return [{ type: MapsAPILoader }, { type: i0.NgZone }]; }, null);
    })();
    ...
    var CircleManager = /** @class */ (function () {
        ...
        CircleManager.prototype.addCircle = function (circle) {
            var _this = this;
            return this._apiWrapper.getNativeMap().then(function () {
                _this._circles.set(circle, _this._apiWrapper.createCircle({
        ...
        CircleManager.prototype.setCenter = function (circle) {
            return this._circles
                .get(circle)
                .then(function (c) { return c.setCenter({ lat: circle.latitude, lng: circle.longitude }); });
        };
        CircleManager.prototype.setEditable = function (circle) {
            return this._circles
                .get(circle)
                .then(function (c) { return c.setEditable(circle.editable); });
        };
        CircleManager.prototype.setDraggable = function (circle) {
            return this._circles
                .get(circle)
                .then(function (c) { return c.setDraggable(circle.draggable); });
        };
    ...
    CircleManager.ɵfac = function CircleManager_Factory(t) { return new (t || CircleManager)(i0.ɵɵinject(GoogleMapsAPIWrapper), i0.ɵɵinject(i0.NgZone)); };
    CircleManager.ɵprov = i0.ɵɵdefineInjectable({ token: CircleManager, factory: CircleManager.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(CircleManager, [{
                type: i0.Injectable
            }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: i0.NgZone }]; }, null);
    })();
    ...
    DataLayerManager.ɵfac = function DataLayerManager_Factory(t) { return new (t || DataLayerManager)(i0.ɵɵinject(GoogleMapsAPIWrapper), i0.ɵɵinject(i0.NgZone)); };
    DataLayerManager.ɵprov = i0.ɵɵdefineInjectable({ token: DataLayerManager, factory: DataLayerManager.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(DataLayerManager, [{
                type: i0.Injectable
            }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: i0.NgZone }]; }, null);
    })();
    ...
    FitBoundsService.ɵfac = function FitBoundsService_Factory(t) { return new (t || FitBoundsService)(i0.ɵɵinject(MapsAPILoader)); };
    FitBoundsService.ɵprov = i0.ɵɵdefineInjectable({ token: FitBoundsService, factory: FitBoundsService.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(FitBoundsService, [{
                type: i0.Injectable
    ...
    AgmGeocoder.ɵfac = function AgmGeocoder_Factory(t) { return new (t || AgmGeocoder)(i0.ɵɵinject(MapsAPILoader)); };
    AgmGeocoder.ɵprov = i0.ɵɵdefineInjectable({ token: AgmGeocoder, factory: AgmGeocoder.ɵfac, providedIn: 'root' });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmGeocoder, [{
                type: i0.Injectable,
    ...
    LazyMapsAPILoader.ɵfac = function LazyMapsAPILoader_Factory(t) { return new (t || LazyMapsAPILoader)(i0.ɵɵinject(LAZY_MAPS_API_CONFIG, 8), i0.ɵɵinject(WindowRef), i0.ɵɵinject(DocumentRef), i0.ɵɵinject(i0.LOCALE_ID)); };
    LazyMapsAPILoader.ɵprov = i0.ɵɵdefineInjectable({ token: LazyMapsAPILoader, factory: LazyMapsAPILoader.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(LazyMapsAPILoader, [{
                type: i0.Injectable
            }], function () {
    ...
    MarkerManager.ɵfac = function MarkerManager_Factory(t) { return new (t || MarkerManager)(i0.ɵɵinject(GoogleMapsAPIWrapper), i0.ɵɵinject(i0.NgZone)); };
    MarkerManager.ɵprov = i0.ɵɵdefineInjectable({ token: MarkerManager, factory: MarkerManager.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(MarkerManager, [{
                type: i0.Injectable
            }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: i0.NgZone }]; }, null);
    })();
    ...
    InfoWindowManager.ɵfac = function InfoWindowManager_Factory(t) { return new (t || InfoWindowManager)(i0.ɵɵinject(GoogleMapsAPIWrapper), i0.ɵɵinject(i0.NgZone), i0.ɵɵinject(MarkerManager)); };
    InfoWindowManager.ɵprov = i0.ɵɵdefineInjectable({ token: InfoWindowManager, factory: InfoWindowManager.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(InfoWindowManager, [{
                type: i0.Injectable
            }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: i0.NgZone }, { type: MarkerManager }]; }, null);
    })();
    ...
    KmlLayerManager.ɵfac = function KmlLayerManager_Factory(t) { return new (t || KmlLayerManager)(i0.ɵɵinject(GoogleMapsAPIWrapper), i0.ɵɵinject(i0.NgZone)); };
    KmlLayerManager.ɵprov = i0.ɵɵdefineInjectable({ token: KmlLayerManager, factory: KmlLayerManager.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(KmlLayerManager, [{
                type: i0.Injectable
            }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: i0.NgZone }]; }, null);
    })();
    ...
    LayerManager.ɵfac = function LayerManager_Factory(t) { return new (t || LayerManager)(i0.ɵɵinject(GoogleMapsAPIWrapper)); };
    LayerManager.ɵprov = i0.ɵɵdefineInjectable({ token: LayerManager, factory: LayerManager.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(LayerManager, [{
                type: i0.Injectable
    ...
    PolygonManager.ɵfac = function PolygonManager_Factory(t) { return new (t || PolygonManager)(i0.ɵɵinject(GoogleMapsAPIWrapper), i0.ɵɵinject(i0.NgZone)); };
    PolygonManager.ɵprov = i0.ɵɵdefineInjectable({ token: PolygonManager, factory: PolygonManager.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(PolygonManager, [{
                type: i0.Injectable
            }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: i0.NgZone }]; }, null);
    })();
    ...
    PolylineManager.ɵfac = function PolylineManager_Factory(t) { return new (t || PolylineManager)(i0.ɵɵinject(GoogleMapsAPIWrapper), i0.ɵɵinject(i0.NgZone)); };
    PolylineManager.ɵprov = i0.ɵɵdefineInjectable({ token: PolylineManager, factory: PolylineManager.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(PolylineManager, [{
                type: i0.Injectable
            }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: i0.NgZone }]; }, null);
    })();
    ...
    var RectangleManager = /** @class */ (function () {
        ...
        RectangleManager.prototype.addRectangle = function (rectangle) {
            var _this = this;
            this._rectangles.set(rectangle, this._apiWrapper.getNativeMap().then(function () { return _this._apiWrapper.createRectangle({
                bounds: {
    ...
    RectangleManager.ɵfac = function RectangleManager_Factory(t) { return new (t || RectangleManager)(i0.ɵɵinject(GoogleMapsAPIWrapper), i0.ɵɵinject(i0.NgZone)); };
    RectangleManager.ɵprov = i0.ɵɵdefineInjectable({ token: RectangleManager, factory: RectangleManager.ɵfac });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(RectangleManager, [{
                type: i0.Injectable
            }], function () { return [{ type: GoogleMapsAPIWrapper }, { type: i0.NgZone }]; }, null);
    })();
    ...
    AgmBicyclingLayer.ɵfac = function AgmBicyclingLayer_Factory(t) { return new (t || AgmBicyclingLayer)(i0.ɵɵdirectiveInject(LayerManager)); };
    AgmBicyclingLayer.ɵdir = i0.ɵɵdefineDirective({ type: AgmBicyclingLayer, selectors: [["agm-bicycling-layer"]], inputs: { visible: "visible" } });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmBicyclingLayer, [{
                type: i0.Directive,
                args: [{
    ...
    var AgmCircle = /** @class */ (function () {
        ...
        AgmCircle.prototype.ngOnInit = function () {
            ...
            rip.then(function () {
                _this._circleAddedToManager = true;
                ...
                _this._eventSubscriptions.push(_this._manager
                    ...
                    switch (eventName) {
                        case 'radius_changed':
                            _this._manager
                                .getRadius(_this)
                                .then(function (radius) { return eventEmitter.emit(radius); });
                            break;
                        case 'center_changed':
                            _this._manager
                                .getCenter(_this)
                                .then(function (center) { return eventEmitter.emit({
                                lat: center.lat(),
                                lng: center.lng(),
                            }); });
                            break;
    ...
    AgmCircle.ɵfac = function AgmCircle_Factory(t) { return new (t || AgmCircle)(i0.ɵɵdirectiveInject(CircleManager)); };
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmCircle, [{
                type: i0.Directive,
                args: [{
                        selector: 'agm-circle',
                    }]
    ...
    AgmDataLayer.ɵfac = function AgmDataLayer_Factory(t) { return new (t || AgmDataLayer)(i0.ɵɵdirectiveInject(DataLayerManager)); };
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmDataLayer, [{
                type: i0.Directive,
                args: [{
    ...
    AgmFitBounds.ɵfac = function AgmFitBounds_Factory(t) { return new (t || AgmFitBounds)(i0.ɵɵdirectiveInject(FitBoundsAccessor, 2), i0.ɵɵdirectiveInject(FitBoundsService)); };
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmFitBounds, [{
                type: i0.Directive,
                args: [{
                        selector: '[agmFitBounds]',
                    }]
            }], function () {
            return [{ type: FitBoundsAccessor, decorators: [{
                            type: i0.Self
    ...
    AgmInfoWindow.ɵfac = function AgmInfoWindow_Factory(t) { return new (t || AgmInfoWindow)(i0.ɵɵdirectiveInject(InfoWindowManager), i0.ɵɵdirectiveInject(i0.ElementRef)); };
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmInfoWindow, [{
                type: i0.Component,
                args: [{
                        selector: 'agm-info-window',
                        template: "<div class='agm-info-window-content'>\n      <ng-content></ng-content>\n    </div>\n  ",
                    }]
            }], function () { return [{ type: InfoWindowManager }, { type: i0.ElementRef }]; }, { latitude: [{
                    type: i0.Input
                }], longitude: [{
                    type: i0.Input
                }], disableAutoPan: [{
    ...
    AgmKmlLayer.ɵfac = function AgmKmlLayer_Factory(t) { return new (t || AgmKmlLayer)(i0.ɵɵdirectiveInject(KmlLayerManager)); };
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmKmlLayer, [{
                type: i0.Directive,
                args: [{
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmMapControl, [{
                type: i0.Directive
            }], null, { position: [{
                    type: i0.Input
                }] });
    ...
    var ɵAgmFullscreenControl_BaseFactory = i0.ɵɵgetInheritedFactory(AgmFullscreenControl);
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmFullscreenControl, [{
                type: i0.Directive,
                args: [{
    ...
    var ɵAgmMapTypeControl_BaseFactory = i0.ɵɵgetInheritedFactory(AgmMapTypeControl);
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmMapTypeControl, [{
                type: i0.Directive,
                args: [{
    ...
    var ɵAgmPanControl_BaseFactory = i0.ɵɵgetInheritedFactory(AgmPanControl);
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmPanControl, [{
                type: i0.Directive,
                args: [{
    ...
    var ɵAgmRotateControl_BaseFactory = i0.ɵɵgetInheritedFactory(AgmRotateControl);
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmRotateControl, [{
                type: i0.Directive,
                args: [{
    ...
    var ɵAgmScaleControl_BaseFactory = i0.ɵɵgetInheritedFactory(AgmScaleControl);
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmScaleControl, [{
                type: i0.Directive,
                args: [{
    ...
    var ɵAgmStreetViewControl_BaseFactory = i0.ɵɵgetInheritedFactory(AgmStreetViewControl);
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmStreetViewControl, [{
                type: i0.Directive,
                args: [{
    ...
    var ɵAgmZoomControl_BaseFactory = i0.ɵɵgetInheritedFactory(AgmZoomControl);
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmZoomControl, [{
                type: i0.Directive,
                args: [{
    ...
    var AgmMap = /** @class */ (function () {
        ...
        AgmMap.prototype._setControls = function () {
            ...
            this.mapControls.forEach(function (control) { return Object.assign(controlOptions, control.getOptions()); });
    ...
    AgmMap.ɵfac = function AgmMap_Factory(t) { return new (t || AgmMap)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(GoogleMapsAPIWrapper), i0.ɵɵdirectiveInject(i0.PLATFORM_ID), i0.ɵɵdirectiveInject(FitBoundsService), i0.ɵɵdirectiveInject(i0.NgZone)); };
    AgmMap.ɵcmp = i0.ɵɵdefineComponent({ type: AgmMap, selectors: [["agm-map"]], contentQueries: function AgmMap_ContentQueries(rf, ctx, dirIndex) {
            if (rf & 1) {
            ...
            if (rf & 2) {
                ...
                PolylineManager,
                RectangleManager,
            ]), i0.ɵɵNgOnChangesFeature], ngContentSelectors: _c0$1, decls: 3, vars: 0, consts: [[1, "agm-map-container-inner", "sebm-google-map-container-inner"], [1, "agm-map-content"]], template: function AgmMap_Template(rf, ctx) {
            if (rf & 1) {
                i0.ɵɵprojectionDef();
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmMap, [{
            ...
            return [{ type: i0.ElementRef }, { type: GoogleMapsAPIWrapper }, { type: Object, decorators: [{
                            type: i0.Inject,
                            args: [i0.PLATFORM_ID]
                        }] }, { type: FitBoundsService }, { type: i0.NgZone }];
        }, { longitude: [{
                    type: i0.Input
                }], latitude: [{
                    type: i0.Input
    ...
    AgmMarker.ɵfac = function AgmMarker_Factory(t) { return new (t || AgmMarker)(i0.ɵɵdirectiveInject(MarkerManager)); };
    AgmMarker.ɵdir = i0.ɵɵdefineDirective({ type: AgmMarker, selectors: [["agm-marker"]], contentQueries: function AgmMarker_ContentQueries(rf, ctx, dirIndex) {
            if (rf & 1) {
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmMarker, [{
                type: i0.Directive,
                args: [{
                        selector: 'agm-marker',
                        providers: [
    ...
    AgmPolygon.ɵfac = function AgmPolygon_Factory(t) { return new (t || AgmPolygon)(i0.ɵɵdirectiveInject(PolygonManager)); };
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmPolygon, [{
                type: i0.Directive,
                args: [{
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmPolylineIcon, [{
                type: i0.Directive,
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmPolylinePoint, [{
                type: i0.Directive,
                args: [{
    ...
    AgmPolyline.ɵfac = function AgmPolyline_Factory(t) { return new (t || AgmPolyline)(i0.ɵɵdirectiveInject(PolylineManager)); };
    AgmPolyline.ɵdir = i0.ɵɵdefineDirective({ type: AgmPolyline, selectors: [["agm-polyline"]], contentQueries: function AgmPolyline_ContentQueries(rf, ctx, dirIndex) {
            if (rf & 1) {
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmPolyline, [{
                type: i0.Directive,
                args: [{
    ...
    AgmRectangle.ɵfac = function AgmRectangle_Factory(t) { return new (t || AgmRectangle)(i0.ɵɵdirectiveInject(RectangleManager)); };
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmRectangle, [{
                type: i0.Directive,
                args: [{
    ...
    AgmTransitLayer.ɵfac = function AgmTransitLayer_Factory(t) { return new (t || AgmTransitLayer)(i0.ɵɵdirectiveInject(LayerManager)); };
    AgmTransitLayer.ɵdir = i0.ɵɵdefineDirective({ type: AgmTransitLayer, selectors: [["agm-transit-layer"]], inputs: { visible: "visible" } });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmTransitLayer, [{
                type: i0.Directive,
                args: [{
    ...
    (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(AgmCoreModule, { declarations: [AgmBicyclingLayer,
                AgmCircle,
                AgmDataLayer,
                AgmFitBounds,
                AgmFullscreenControl,
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(AgmCoreModule, [{
                type: i0.NgModule,
