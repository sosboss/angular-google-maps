...
export declare class MarkerManager {
  ...
  convertAnimation(
    uiAnim: keyof typeof google.maps.Animation | null
  ): Promise<google.maps.Animation>;
  ...
  static ɵfac: i0.ɵɵFactoryDef<MarkerManager, never>;
  static ɵprov: i0.ɵɵInjectableDef<MarkerManager>;
}
