...
export declare class AgmFitBounds implements OnInit, OnDestroy, OnChanges {
     ...
     */
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDef<AgmFitBounds, [{ self: true; }, null]>;
    static ɵdir: i0.ɵɵDirectiveDefWithMeta<AgmFitBounds, "[agmFitBounds]", never, { "agmFitBounds": "agmFitBounds"; }, {}, never>;
}
